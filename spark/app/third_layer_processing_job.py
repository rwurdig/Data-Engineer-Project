...
def main():
    ...
    trips_df = spark.read.format("parquet").load(f"hdfs://{namenode}/data/bronze/datatrip/")
    ...
    write_to_hdfs(grouped_df, f"hdfs://{namenode}/data/silver/datatrip/")
    ...
    write_to_hdfs(preprocess_data, f"hdfs://{namenode}/data/silver/rawdatatrip/")
